...
``` yaml
openapi-type: arm
tag: package-2020-07-17
```

### Tag: package-2020-07-17

These settings apply only when `--tag=package-2020-07-17` is specified on the command line.

``` yaml $(tag) == 'package-2020-07-17'
input-file:
- Microsoft.AVS/stable/2020-07-17/vmware.json
directive:
  - suppress: R3020
    from: vmware.json
